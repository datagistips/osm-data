  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" forceraster="0" enableorderby="1">
    <rules key="{44a02ec9-8bbe-4c71-9fca-3aef0ddcf5ee}">
      <rule scalemindenom="10000" scalemaxdenom="100000000" key="{486559e7-72ff-4215-8566-0b65520bff08}" symbol="0" label="zoom faible">
        <rule filter="hstore_to_json['drinking_water'] in( 'conditional', 'conditionnal')" key="{095718ee-1495-45a2-b3b0-9134a192d64c}" symbol="1" label="Eau potable : conditionnel"/>
        <rule filter="hstore_to_json['drinking_water'] in ('indefined', 'undefined', 'unknown')" key="{61405a40-f4c1-45df-9ca6-3a75a029a19d}" symbol="2" label="Eau potable : non défini"/>
        <rule filter="hstore_to_json['drinking_water'] = 'legal:no'" key="{6ef1fbff-6897-493b-9bf0-3fdb3325ab2e}" symbol="3" label="Eau potable : non"/>
        <rule filter="hstore_to_json['drinking_water'] = 'mineral'" key="{047a3274-5f4e-467d-a2bb-fdba347704ce}" symbol="4" label="Eau potable : minérale"/>
        <rule filter="hstore_to_json['drinking_water'] in ('no', 'none')" key="{ffba8f9c-1177-4546-855e-befd59ff9877}" symbol="5" label="Eau potable : non"/>
        <rule filter="hstore_to_json['drinking_water'] like  'not_surveyed%' or hstore_to_json['drinking_water'] = 'unwatched'" key="{e66df692-7e33-4e9f-98da-60f7197999ef}" symbol="6" label="Eau potable : non surveillée"/>
        <rule filter="hstore_to_json['drinking_water'] in ('oui', 'yes')" key="{dfe3dcf0-0a08-45af-ad88-1dfa5f2ad265}" symbol="7" label="Eau potable : oui"/>
        <rule filter="hstore_to_json['drinking_water'] = 'seasonal'" key="{e7fe89d6-4c8e-4b65-8fed-0b68a79a6830}" symbol="8" label="Eau potable : saisonnière"/>
        <rule filter="hstore_to_json['drinking_water'] = 'untreated'" key="{8835315c-7ad5-4b2d-b509-7c8029a439bc}" symbol="9" label="Eau potable : non traitée"/>
        <rule filter="ELSE" key="{111d1ac8-b6ab-4b33-acea-4e03053c451f}" symbol="10" label="Autres"/>
      </rule>
      <rule scalemindenom="1" scalemaxdenom="10000" key="{31d3d072-ef20-440f-b08c-7108ca068f7d}" symbol="11" label="zoom fort">
        <rule key="{c464567a-45f7-414d-a8b2-6cf8b3772bf4}" symbol="12" label="drinking_water">
          <rule filter="hstore_to_json['drinking_water'] IN ('conditional', 'conditionnal')" key="{475710e9-5df4-4dd2-9bc9-115af200b26c}" symbol="13" label="Eau potable : conditionnel"/>
          <rule filter="hstore_to_json['drinking_water'] in( 'indefined', 'undefined', 'unknown')" key="{cbb496ab-84c4-4afe-a2e6-354288a50c3b}" symbol="14" label="Eau potable : non défini"/>
          <rule filter="hstore_to_json['drinking_water'] in ('legal:no', 'no', 'none')" key="{c7ad3832-f1e6-4dcb-9047-f6cf0fadbdf8}" symbol="15" label="Eau potable : non"/>
          <rule filter="hstore_to_json['drinking_water'] = 'mineral'" key="{5279ef13-bd61-4ca3-9573-28f90cfdc8c8}" symbol="16" label="Eau potable : minérale"/>
          <rule filter="hstore_to_json['drinking_water'] like 'not_surveyed%' or hstore_to_json['drinking_water']='unwatched'" key="{2a5db27c-eec6-4d0f-ac34-b94fde7155f4}" symbol="17" label="Eau potable : non surveillée"/>
          <rule filter="hstore_to_json['drinking_water'] = 'seasonal'" key="{01811a2d-de71-42cd-b5b1-8760a1737c46}" symbol="18" label="Eau potable : saisonnière"/>
          <rule filter="hstore_to_json['drinking_water'] = 'untreated'" key="{b9a9ab9f-4169-4fa5-8879-0d818e1cb5f4}" symbol="19" label="Eau potable : non taitée"/>
          <rule filter="hstore_to_json['drinking_water'] in ('yes', 'oui')" key="{fa3b93d9-9374-4f09-af5b-634909801bd7}" symbol="20" label="Eau potable : oui"/>
          <rule filter="ELSE" key="{7fb2b80d-2ce2-4b1c-b3f2-c10031dd01cf}" symbol="21" label="Autres"/>
        </rule>
        <rule key="{fc860cc0-7b93-4837-8392-3b71269280b8}" symbol="22" label="fountain">
          <rule filter="hstore_to_json['fountain'] = 'mist'" key="{feba8b3b-be5c-47c7-adb5-f6a28d3c5e02}" symbol="23" label="Brumisateur"/>
          <rule filter="hstore_to_json['fountain'] = 'nasone'" key="{6cf5f3d6-15dd-4e81-acdb-2231cc3f6a15}" symbol="24" label="Fontaine publique"/>
          <rule filter="hstore_to_json['fountain'] = 'nozzle'" key="{0fb7b111-2c65-43bd-b3ed-fa9c2f4864bc}" symbol="25" label="Buse"/>
          <rule filter="hstore_to_json['fountain'] = 'splash_pad' or hstore_to_json['fountain'] = 'splash_pad;lillypad;medieval'" key="{10314c33-611a-4694-8f0a-e3155bae98bb}" symbol="26" label="Jeux d'eau"/>
          <rule filter="hstore_to_json['fountain'] = 'stone_block'" key="{280e0ce4-ff8e-46df-9df5-724f01965a10}" symbol="27" label="Fontaine en pierre"/>
          <rule filter="ELSE" key="{44ef1727-f7a5-4ba2-b1dc-5ea99933c410}" symbol="28" label="Autres"/>
        </rule>
        <rule key="{3cf37c22-ed95-4e51-8d64-f741f893f09d}" symbol="29" label="light">
          <rule filter="hstore_to_json['lit'] = 'automatic'" key="{b3e9da66-176e-473f-a980-de1fb02a68e4}" symbol="30" label="Eclairage automatique"/>
          <rule filter="hstore_to_json['lit'] = 'no'" key="{dadcd6e0-cc26-4faf-b913-6c47c3151112}" symbol="31" label="Non éclairée"/>
          <rule filter="hstore_to_json['lit'] = 'yes'" key="{af1815d1-9e07-4ed9-8b14-31ceb1328d28}" symbol="32" label="Eclairée"/>
        </rule>
        <rule key="{3020ba57-67b6-4931-9015-7b98e9c5dc9d}" symbol="33" label="tourism">
          <rule filter="hstore_to_json['tourism'] = 'artwork'" key="{db26078a-0753-4412-b24f-e6bda519a30a}" symbol="34" label="Œuvre d'art"/>
          <rule filter="hstore_to_json['tourism'] = 'attraction'" key="{68c748e5-bfed-40f5-a080-b409698bf229}" symbol="35" label="Attraction touristique"/>
          <rule filter="hstore_to_json['tourism'] = 'information'" key="{3a7298ce-8ff8-423e-ad39-a7acf0eb2631}" symbol="36" label="Touristique"/>
          <rule filter="hstore_to_json['tourism'] = 'museum'" key="{9725f210-57e0-4641-8859-f471b76bec63}" symbol="37" label="Musée"/>
          <rule filter="hstore_to_json['tourism'] = 'yes;attraction'" key="{2ddf2597-e48a-481a-ad47-d1be33d8396b}" symbol="38" label="Attraction touristique"/>
        </rule>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" force_rhr="0" name="10">
        <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
          <prop v="0" k="angle"/>
          <prop v="185,238,255,255" k="color"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="circle" k="name"/>
          <prop v="0,0" k="offset"/>
      ...
      <symbol alpha="0.3" clip_to_extent="1" type="marker" force_rhr="0" name="13">
        <layer pass="0" class="SvgMarker" enabled="1" locked="1">
          <prop v="0" k="angle"/>
          <prop v="255,158,23,255" k="color"/>
          <prop v="0" k="fixedAspectRatio"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" force_rhr="0" name="15">
        <layer pass="0" class="SvgMarker" enabled="1" locked="1">
          <prop v="0" k="angle"/>
          <prop v="255,158,23,255" k="color"/>
          <prop v="0" k="fixedAspectRatio"/>
      ...
      <symbol alpha="0.3" clip_to_extent="1" type="marker" force_rhr="0" name="18">
        <layer pass="0" class="SvgMarker" enabled="1" locked="1">
          <prop v="0" k="angle"/>
          <prop v="255,158,23,255" k="color"/>
          <prop v="0" k="fixedAspectRatio"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" force_rhr="0" name="22">
        <layer pass="0" class="SvgMarker" enabled="1" locked="1">
          <prop v="0" k="angle"/>
          <prop v="255,158,23,255" k="color"/>
          <prop v="0" k="fixedAspectRatio"/>
